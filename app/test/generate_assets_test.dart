    ...
    loader.addFont(
      Future.value(
        ByteData.sublistView(
          File('assets/fonts/Nunito-$w.ttf').readAsBytesSync(),
        ),
      ),
    );
  }
  ...
  testWidgets('generate icons & store art', (tester) async {
    await tester.runAsync(() async {
      ...
      for (final e in densities.entries) {
        ...
        await _png('$res/mipmap-${e.key}/ic_launcher_round.png', s, s, (
          c,
          size,
        ) {
      ...
      await _png(
        ...
        512,
        512,
        (c, s) => NaglyLogoPainter(cornerRadius: 0).paint(c, s),
      );
      await _png(
        'store/icon-1024.png',
        1024,
      ...
      await _png('store/feature-graphic.png', 1024, 500, (c, size) {
        ...
        _text(
          c,
          'Mom, Dad, Dadi & your Bestie nag you to\ndrink water and take your pills.',
          const Offset(398, 320),
          28,
          FontWeight.w700,
