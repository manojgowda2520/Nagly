# App Store listing — Nagly (iOS, seller XcelAudit Technologies LLP)

iOS has NO ads (owner's rule). Copy below is the Play listing minus the ad line, plus Apple's subscription terms.

**Name (≤30):** Nagly: Mom's Water & Pill Nags
**Subtitle (≤30):** Water & pill reminders w/ love
**Promotional text (≤170):** Mom nags you to drink water & take your pills, vitamins or creatine. Lovingly. Relentlessly. 15 voices, one-tap logging, first reminder free forever.
**Keywords (≤100):** water,reminder,hydration,pill,medication,supplement,vitamin,creatine,protein,habit,tracker,mom,nag
**Category:** Health & Fitness (secondary: Lifestyle)
**Support URL:** https://manojgowda2520.github.io/Nagly/
**Marketing URL:** (none)
**Privacy Policy URL:** https://manojgowda2520.github.io/Nagly/privacy.html
**Copyright:** 2026 XcelAudit Technologies LLP
**Age rating:** 4+ (no objectionable content; medical/treatment info: none)
...
Subscriptions renew automatically unless cancelled at least 24 hours before the end of the current period. Payment is charged to your Apple ID. Manage or cancel any time in Settings > Apple ID > Subscriptions. Any unused part of the free trial is forfeited when you buy a subscription.
Terms of Use: https://manojgowda2520.github.io/Nagly/terms.html
Privacy Policy: https://manojgowda2520.github.io/Nagly/privacy.html
```

## What's New — 1.0.1

```
• New family: Spouse — Caring Wife, Worried Husband and Sarcastic Partner.
• Make it yours: give your nagger a real name and emoji.
• Meds & Supplements: remind yourself about vitamins, creatine or protein too, with one-tap quick picks.
• A short tour shows you around on first open.
```

## App Privacy (nutrition label)
- Data used to track you: **None** (no ads, no ATT on iOS).
- Entered in App Store Connect 2026-09-22 (not yet published): User ID, Device ID, Purchase History, Product Interaction, each App Functionality, linked to user (device-linked anonymous IDs), not tracking.
- Health data (water, medication names): stays on device, **not collected**.

## Review notes
No login needed. Every Pro feature is free for the first days; after that, the paywall appears when tapping a locked voice (Dad/Grandparent/Bestie/Spouse), using "Make it yours", or adding a 2nd med or supplement. Purchases use Apple StoreKit via RevenueCat. The app contains no ads.
