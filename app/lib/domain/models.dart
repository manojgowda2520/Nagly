...
class DrinkLog {
  const DrinkLog({required this.id, required this.timestampMs, required this.amountMl});
...
class Medication {
  ...
  Medication copyWith({String? name, String? dose, int? hour, int? minute}) => Medication(
        id: id,
        name: name ?? this.name,
        dose: dose ?? this.dose,
        hour: hour ?? this.hour,
